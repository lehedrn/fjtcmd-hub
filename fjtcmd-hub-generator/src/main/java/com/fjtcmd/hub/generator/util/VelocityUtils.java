package com.fjtcmd.hub.generator.util;
...
public class VelocityUtils
{
    ...
    public static List<String> getTemplateList(GenTable table)
    {
        ...
        if (GenConstants.TPL_CRUD.equals(tplCategory))
        {
            ...
            if (table.isIsSubTable())
            {
                templates.add(useWebType + "/sub-index.vue.vm");
            }
            else
            {
            ...
            {
                templates.add("vm/ts/route-index-bak.ts.vm");
            }
        }
    ...
    public static String getFileName(String template, GenTable genTable)
    {
        ...
        else if (template.contains("route-index-bak.ts.vm"))
        {
            fileName = StringUtils.format("{}/route-index-bak.ts", vuePath);
        }
