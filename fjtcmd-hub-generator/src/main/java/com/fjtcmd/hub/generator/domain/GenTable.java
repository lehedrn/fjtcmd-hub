package com.fjtcmd.hub.generator.domain;
...
public class GenTable extends BaseEntity
{
    ...
    /** 子表配置信息（用于模板访问） */
    private SubTableConfig subTableConfig;

    /** 是否是子表（子表配置） */
    private boolean isSubTable;

    /** 主表配置信息（用于模板访问） */
    private MainTableConfig mainTableConfig;
    ...
    public boolean isIsSubTable()
    {
        return isSubTable;
    }

    public void setIsSubTable(boolean isSubTable)
    {
        this.isSubTable = isSubTable;
    }

    public MainTableConfig getMainTableConfig()
    {
        return mainTableConfig;
    }

    public void setMainTableConfig(MainTableConfig mainTableConfig)
    {
        this.mainTableConfig = mainTableConfig;
    }

    /**
     * 获取主表配置（用于模板访问 $table.mainTable）
     */
    public MainTableConfig getMainTable()
    {
        return mainTableConfig;
    }
