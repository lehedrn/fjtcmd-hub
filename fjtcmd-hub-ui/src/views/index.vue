  ...
  <div class="app-container home">
    <el-row :gutter="20">
      <el-col :sm="24" :lg="12" style="padding-left: 20px">
        <h2>体彩门店智慧互动信息管理系统</h2>
        <p>
          基于 RuoYi-Vue 框架二次开发，面向体彩门店提供智慧互动信息化管理能力。系统继承若依的用户、角色、权限等基础能力，并在此基础上定制业务模块，满足门店互动信息管理的实际需求。
        </p>
        <p>
    ...
    <el-row :gutter="20">
      <el-col :xs="24" :sm="24" :md="12" :lg="8">
        <el-card class="update-log">
          ...
          <div class="body">
            <p>
              <i class="el-icon-s-platform"></i> 框架：基于 RuoYi-Vue v3.9.2 二次开发
            </p>
            <p>
              <i class="el-icon-s-custom"></i> 面向：体彩门店智慧互动信息管理
            </p>
          </div>
        </el-card>
      </el-col>
