...
public class DdlParser
{
    ...
    private static GenTable parseTable(MySqlCreateTableStatement createStmt, String operName)
    {
        ...
        genTable.setTplWebType("element-plus-typescript");

        // 使用 GenUtils 初始化包名、模块名、类名等（读取 GenConfig 静态字段）
        ...
        log.info("解析表: {} ({})，共 {} 列", tableName, genTable.getTableComment(), columns.size());
        return genTable;
    }
