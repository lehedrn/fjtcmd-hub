...
public class GoodsController extends BaseController
{
     ...
     * 查询商品信息列表
     */
    @PreAuthorize("@ss.hasPermi('demo:customer:goods:list')")
    @GetMapping("/list")
     ...
     * 导出商品信息列表
     */
    @PreAuthorize("@ss.hasPermi('demo:customer:goods:export')")
     ...
     * 获取商品信息详细信息
     */
    @PreAuthorize("@ss.hasPermi('demo:customer:goods:query')")
     ...
     * 新增商品信息
     */
    @PreAuthorize("@ss.hasPermi('demo:customer:goods:add')")
     ...
     * 修改商品信息
     */
    @PreAuthorize("@ss.hasPermi('demo:customer:goods:edit')")
     ...
     * 删除商品信息
     */
    @PreAuthorize("@ss.hasPermi('demo:customer:goods:remove')")
